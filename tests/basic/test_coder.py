...
from dev.coders.base_coder import FinishReasonLength, UnknownEditFormat
...
from dev.sendchat import sanity_check_messages
...
"""
    ...
    def test_skip_devignored_files(self):
        with GitTemporaryDirectory():
            repo = git.Repo()
