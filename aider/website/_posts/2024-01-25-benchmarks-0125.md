...
[![benchmark results](/assets/benchmarks-0125.svg)](https://dev.chat/assets/benchmarks-0125.svg)
...
dev's existing
[lazy coding benchmark](https://dev.chat/docs/unified-diffs.html).
...
- It gets worse benchmark scores when using the [unified diffs](https://dev.chat/docs/unified-diffs.html) code editing format.
- Using dev's older SEARCH/REPLACE block editing format, the new January model outperforms the older November model. But it still performs worse than both models using unified diffs.
...
- [Code editing benchmarks for OpenAI's "1106" models](https://dev.chat/docs/benchmarks-1106.html).
- [Dev's lazy coding benchmark](https://dev.chat/docs/unified-diffs.html).
