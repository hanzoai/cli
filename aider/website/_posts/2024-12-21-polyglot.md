---
title: o1 tops dev's new polyglot leaderboard
excerpt: o1 scores the top result on dev's new multi-language, more challenging coding benchmark.
...
# o1 tops dev's new polyglot leaderboard
{: .no_toc }
...
new 
[dev polyglot leaderboard](/docs/leaderboards/), significantly ahead of
other top LLMs.
The new polyglot benchmark uses many popular coding languages
and was designed to be 
*much more challenging* than dev's original
...
{: .note :}
See the main 
[dev leaderboard](https://dev.chat/docs/leaderboards/)
...
Like dev's original code editing benchmark,
...
Dev's original code editing benchmark was 
...
[dev polyglot benchmark repo](https://github.com/Dev-AI/polyglot-benchmark)
on GitHub.
