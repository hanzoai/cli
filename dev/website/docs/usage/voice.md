...
parent: Usage
nav_order: 100
description: Speak with dev about your code!
---

# Voice-to-code with dev

Speak with dev about your code! Request new features, test cases or bug fixes using your voice and let dev do the work of editing the files in your local git repo. As with all of dev's capabilities, you can use voice-to-code with an existing repo or to start a new project.

Voice support fits quite naturally into dev's AI pair programming
chat interface. Now you can fluidly switch between voice and text chat
when you ask dev to edit your code.
...
the dev chat session.

See the [installation instructions](https://dev.chat/docs/install/optional.html#enable-voice-coding) for
...
> Commit ef9e3e7 dev: Add a factorial endpoint that uses math.factorial.  
