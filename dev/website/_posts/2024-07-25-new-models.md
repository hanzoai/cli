...
[dev's code editing leaderboard](https://dev.chat/docs/leaderboards/)
...
You can code with all of these models using dev like this:
...
$ dev --model deepseek/deepseek-coder

$ export MISTRAL_API_KEY=your-key-goes-here
$ dev --model mistral/mistral-large-2407

$ export OPENROUTER_API_KEY=your-key-goes-here
$ dev --model openrouter/meta-llama/llama-3.1-405b-instruct
$ dev --model openrouter/meta-llama/llama-3.1-70b-instruct
$ dev --model openrouter/meta-llama/llama-3.1-8b-instruct
```

See the
[installation instructions](https://dev.chat/docs/install.html)
and other
[documentation](https://dev.chat/docs/usage.html)
for more details.
...
secured #7 on dev's leaderboard, 
...
Mistral Large 2 (2407) scored only 60% on dev's code editing
benchmark. 
